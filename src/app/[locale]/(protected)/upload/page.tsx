...
export default function AvatarUploadPage() {
  ...
  return (
    <div className='flex flex-col items-center'>
      <div className='mx-auto min-h-96 w-full max-w-4xl rounded-lg border border-neutral-300 border-dashed bg-white hover:border-neutral-500 md:m-10 dark:border-neutral-600 dark:bg-black dark:hover:border-neutral-500'>
        <FileUpload
          ref={fileUploadRef}
              ...
              <div className='flex max-h-[50vh] w-[500px] flex-col gap-5 overflow-y-auto p-5'>
                <div className='flex flex-col gap-5'>
                  ...
                  <Popover>
                    ...
                    <PopoverContent className='w-auto p-0'>todo</PopoverContent>
                  </Popover>
                </div>

                <div className='flex flex-col gap-5'>
                  <div className='flex w-full items-center justify-center gap-2'>
                    <Label className='relative text-center text-md'>
                      <div>位置</div>
                ...
                <div className='flex flex-col gap-5'>
                  <Label className='text-center text-md'>设备</Label>
                  <div className='grid grid-cols-2 gap-5'>
                    <div className='flex items-center justify-center gap-2'>
                ...
                <div className='flex flex-col gap-5'>
                  <Label className='text-center text-md'>参数</Label>
                  <div className='grid grid-cols-2 gap-5'>
