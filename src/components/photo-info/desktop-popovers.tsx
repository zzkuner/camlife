  ...
  return (
    <>
      <Popover>
        ...
        <PopoverContent className='hidden w-auto rounded-2xl bg-white/80 backdrop-blur-sm md:block dark:bg-black/80'>
      ...
      <Popover>
        ...
        {!!latitude && !!longitude && (
          <PopoverContent className='hidden w-auto gap-4 rounded-2xl bg-white/80 backdrop-blur-sm md:flex dark:bg-black/80'>
            <LocationDisplay
              latitude={latitude ?? 0}
