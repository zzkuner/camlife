...
export function PhotoInfoDetails({
  ...
  const content = (
    <>
      ...
      <div className='my-4 text-center font-medium text-lg'>{t('exif')}</div>
  ...
  return !isMobile ? (
    <Popover>
      ...
      <PopoverContent className='scrollbar-hide hidden max-h-[500px] w-auto flex-col gap-4 overflow-auto rounded-2xl bg-white/80 backdrop-blur-sm md:flex dark:bg-black/80'>
        {content}
      </PopoverContent>
    </Popover>
  ) : (
