...
export function Tabs() {
  ...
  return (
    <div
      className={cn(
        'z-[48] my-5 flex h-16 w-full items-center justify-between bg-white px-6 md:justify-start md:gap-5 md:px-12 xl:px-48 dark:bg-black',
        isScrolled &&
        ...
        locale === 'zh'
          ...
          : `${fontTabsEN.className} font-normal text-lg md:text-2xl`,
      )}
    >
      {tabsConfig.map((item) => (
        <div
